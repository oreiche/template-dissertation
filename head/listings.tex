...
\lstset{%
  ...
  numbers=left,
  numbersep=5pt,
  basicstyle=\lst@ifdisplaystyle\ttfamily\scalefont{.75}\else\ttfamily\scalefont{.95}\fi,
...
\DeclareCaptionFormat{listing}{\colorbox{captiongray}{\parbox[c][2ex][c]{\linewidth-6pt}{%
  \settodepth{\captionskip}{g}\vspace{\captionskip}%
  \settoheight{\captionskip}{Lg}\setlength{\captionskip}{1ex-.5\captionskip}\hspace{\captionskip}%
  #1#2#3}}}
